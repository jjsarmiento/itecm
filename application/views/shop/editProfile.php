<div class="row">
    <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4 well" style="text-align: justify; border : 1px solid #f5f5f5 !important;">
        ...
        <div class="thumbnailx"  style="height: 170px;">
            <img class="prod-img" src="<?=$_SESSION['disp_pic']?>" />
        </div>
        ...
        <div class="form-group">
            <i class="fa fa-map-marker" style="color: #3498DB;"></i> <?=$_SESSION['address']?>
        </div>

        <div class="form-group">
            <i class="fa fa-phone" style="color: #3498DB;"></i> <?=$_SESSION['contact']?>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6 col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="editFname" name="editFname" value="<?=$_SESSION['firstname']?>" required="required" />
                    </div>
                    <div class="form-group">
                        <label for="editLname">Last Name</label>
                        <input class="form-control" type="text" id="editLname" name="editLname" value="<?=$_SESSION['lastname']?>" required="required" />
                    </div>
                    <div class="form-group">
                        <label for="editAbout">About you</label>
                        <textarea id="editAbout" name="editAbout" class="form-control" rows="8" required="required"><?=$_SESSION['about']?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="editAddress">Address</label>
                        <textarea id="editAddress" name="editAddress" class="form-control" rows="8" required="required"><?=$_SESSION['address']?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="editContact">Contact Number</label>
                        <input class="form-control" type="text" id="editContact" name="editContact" value="<?=$_SESSION['contact']?>"  required="required"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="editBdate" name="editBdate" placeholder="Birthdate" readonly />
                    </div>
                    <div class="well">
                        <?php
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 well">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="editEmail" name="editEmail" value="<?=$_SESSION['email']?>"  required="required" />
                    </div>
